...
export default function MintAudio() {
    ...
    }, [ titleText, uploadedImageFile, uploadedAudioFile, categoryName]); // Add "authorName" and "descriptionText" back if needed
            ...
            <main style={styles.main}>
                ...
                >
                    <Text style={styles.text}>
                        Upload the Image that will represent your Audio NFT (max file size: 1GB)
                    </Text>
                    <NftImageUploader
                    ...
                    <br />
                    <Text style={styles.text}>
                        Upload the Audio that will represent your Audio NFT (max file size: 1GB)
                    </Text>
                    <NftAudioUploader
