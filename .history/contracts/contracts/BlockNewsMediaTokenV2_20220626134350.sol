    ...
    ERC721Burnable
{
    ...
    /// @param itemText - the text included in the post (not ipfs hosted)
    /// @param itemImg - the image included in the post (ipfs hosted)
    /// @param itemAudio - the audio file included in the post (ipfs hosted)
    /// @param itemVideo - the video file included in the post (ipfs hosted)
        ...
        returns (uint256)
    {
        ...
        // NOT SURE HOW TO PROPERLY IMPLEMENT THE COUNTER, 
        // MAYBE IT WOULD BE BETTER TO GO BACK TO JUST HAVUNG THE URI
        // Item storage newItem = items[_tokenIds.increment()];
