        ...
        if (isAuthenticated) {
            ...
            executeContractFunction({
                params: {
                    ...
                    msgValue: Moralis.Units.ETH(1), // Change to 1 Matic when deploy on main net
                },
                onSuccess: () => {
                    saveAudio();
                },
            ...
            <main style={styles.main}>
                ...
                >
                    <Text style={styles.text}>
                        Upload the Image that will represent your NFM (JPEG and PNG Files ONLY, max file size: 1GB)
                    </Text>
                    <NftImageUploader
                    ...
                    <br />
                    <Text style={styles.text}>
                        Upload the Music that will represent your NFM (MP3 Files ONLY, max file size: 1GB)
                    </Text>
                    <NftAudioUploader
