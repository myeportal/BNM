            ...
            <main style={styles.main}>
                ...
                >
                    <Text style={styles.text}>
                        Upload the Image that will represent your NFV (JPEG and PNG Files ONLY, max file size: 4mb)
                    </Text>
                    <NftImageUploader
                    ...
                    <br />
                    <Text style={styles.text}>
                        Upload the Video that will represent your NFV (MP4 Files ONLY, max file size: 4mb)
                    </Text>
                    <NftVideoUploader
