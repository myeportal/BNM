        ...
        <div style={styles.container}>
            ...
            <main style={styles.main}>
                <Card
                    ...
                    title={"Mint your Audio as NFM"}
                    loading={isNftMintInProcess}
                >
                    <Text style={styles.text}>
                        Upload the Image that will represent your Audio NFM (max file size: 1GB)
                    </Text>
                    <NftImageUploader
                    ...
                    <br />
                    <Text style={styles.text}>
                        Upload the Audio that will represent your Audio NFM (max file size: 1GB)
                    </Text>
                    <NftAudioUploader
