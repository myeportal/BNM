        ...
        if (isAuthenticated) {
            ...
            executeContractFunction({
                params: {
                    ...
                    msgValue: Moralis.Units.ETH(0.01), // Change to 1 before deploying to main net 
                },
                onSuccess: () => {
                    saveArticle();
                },
            ...
            <main style={styles.main}>
                ...
                >
                    <Text style={styles.text}>
                        Upload the Image that will represent your NFA (JPEG and PNG Files ONLY, max file size: 1GB)
                    </Text>
                    <NftImageUploader
