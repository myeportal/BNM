...
export default function mintAudio() {
    ...
    const uploadNftToIpfsAndMintToken = async () => {
        if (isAuthenticated) {
            ...
            const nftVideo = await saveFile("nft", uploadedFile, {
                saveIPFS: true,
            });
            ...
            <main style={styles.main}>
                ...
                >
                    <Text style={styles.text}>
                        Upload the Video that will represent your NFT (max file size: 1GB)
                    </Text>
                    <NftVideoUploader
                    ...
                    <TextArea
                        placeholder="Describe your Video with up to 512 characters!"
                        showCount
                        maxLength={512}
                        style={{ height: 145 }}
