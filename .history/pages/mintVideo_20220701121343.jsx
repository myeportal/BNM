            ...
            <main style={styles.main}>
                ...
                >
                    <Text style={styles.text}>
                        Upload the Image that will represent your Video NFV (JPEG and PNG Files ONLY, max file size: 1GB)
                    </Text>
                    <NftImageUploader
                    ...
                    <br />
                    <Text style={styles.text}>
                        Upload the Video that will represent your Video NFV (MP4 Files ONLY, max file size: 1GB)
                    </Text>
                    <NftVideoUploader
