    ...
    const uploadNftToIpfsAndMintToken = async () => {
        if (isAuthenticated) {
            ...
            let options = {
                ...
                abi: [{ "inputs": [ { "internalType": "string", "name": "uriOfToken", "type": "string" }, { "internalType": "string", "name": "itemText", "type": "string" }, { "internalType": "string", "name": "itemImg", "type": "string" }, { "internalType": "string", "name": "itemAudio", "type": "string" }, { "internalType": "string", "name": "itemVideo", "type": "string" } ], "name": "createItem", "outputs": [ { "internalType": "uint256", "name": "", "type": "uint256" } ], "stateMutability": "payable", "type": "function" }],
                params: {
