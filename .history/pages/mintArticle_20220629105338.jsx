...
export default function mintArticle() {
    ...
    }, [descriptionText, titleText, uploadedFile, categoryName]); //Add "authorName" back if needed
    ...
    const uploadNftToIpfsAndMintToken = async () => {
        if(!isInputValid) {
            ...
            window.alert("Not all fields filled in! Please fill in all fields and then re-sumbit.")
            setIsNftMintInProcess(false);
            return
        }
