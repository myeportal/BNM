...
export default function mintAudio() {
    ...
    }, [ titleText, uploadedImageFile, uploadedVideoFile, categoryName]); // Add "authorName" and "descriptionText" back if needed
            ...
            <main style={styles.main}>
                ...
                >
                    <Text style={styles.text}>
                        Upload the Image that will represent your Video NFT (max file size: 1GB)
                    </Text>
                    <NftImageUploader
                    ...
                    <br />
                    <Text style={styles.text}>
                        Upload the Video that will represent your Video NFT (max file size: 1GB)
                    </Text>
                    <NftVideoUploader
