            ...
            <main style={styles.main}>
                ...
                >
                    <Text style={styles.text}>
                        Upload the Image that will represent your NFM (JPEG and PNG Files ONLY, max file size: 4mb)
                    </Text>
                    <NftImageUploader
                    ...
                    <br />
                    <Text style={styles.text}>
                        Upload the Music that will represent your NFM (MP3 Files ONLY, max file size: 4mb)
                    </Text>
                    <NftAudioUploader
