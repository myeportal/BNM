...
/// @author Bryce Palichuk & Lukas Knutti <hello@rootine.ch>
/// @notice To mint/buy/sell articles, music, and videos as NFTs, please head to blocknewsmedia.us
    ...
    Ownable
{
    ...
    constructor() ERC721("BlockNewsMediaV2", "BNM2") {
        ...
        returns (uint256)
    {
        require(
            ...
            "BlockNewsMediaTokenV2: No Token URI supplied"
        );
        require(
            msg.value == (1000000000000000000 wei), "Please pay 1 Matic" 
        );
